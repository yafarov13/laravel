...
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
    ...
    <div class="col">
        <div class="card shadow-sm">
            <img src=" {{$news['image']}} ">
            <div class="card-body">
                <strong><a href="{{ route('category.showNewsId', ['category' => $category['category'], 'id' => $news['id']]) }}">
                        {{$news['title']}}
                    </a></strong>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                        <a href="{{ route('category.showNewsId', ['category' => $category['category'], 'id' => $news['id']]) }}" class="btn btn-sm btn-outline-secondary">Подробнее</a>
                    </div>
